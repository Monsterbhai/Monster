...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        start = datetime.now()
        altron = await e.reply(f"» 𝐌𝐎𝐍𝐒𝐓𝐄𝐑 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓\n🔸𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 - @aboutmannu\n🔸𝐀 𝐏𝐚𝐫𝐭 𝐎𝐟 - @monstercopyright1")
        end = datetime.now()
        mp = (end - start).microseconds / 1000
        await altron.edit(f"𝐌𝐎𝐍𝐒𝐓𝐄𝐑 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓\n🔸𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 - @aboutmannu🔸𝐀 𝐏𝐚𝐫𝐭 𝐎𝐟 - @monstercopyright1\n» `{mp} ᴍꜱ`")
