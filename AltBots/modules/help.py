...
HELP_STRING = f"★𝐌𝐎𝐍𝐒𝐓𝐄𝐑 𝐁𝐎𝐓𝐒 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @patel1154**"
...
HELP_BUTTON = [
    ...
    [
      ...
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/monstarlove")
    ]
  ]
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Hacker OP Bots !! @patel1154", cache_time=0, alert=True)
...
async def help_spam(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own MONSTER Bots !! @aboutmannu", cache_time=0, alert=True)
...
async def help_extra(event):
    if event.query.user_id in SUDO_USERS:
        ...
        await event.answer("Make Your Own Monster Bots !! @PATEL1154", cache_time=0, alert=True)
